...
import { Star, ShoppingCart, ArrowLeft, ShieldCheck, Truck, RotateCcw, Heart, Gift, Info, CheckCircle2, ChevronRight } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="flex flex-col space-y-6">
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="h-4 w-px bg-gray-200"></div>
                <span className="text-sm text-gray-500 font-bold uppercase tracking-tighter">Đã bán {product.salesCount || 0}+</span>
              </div>

              <div className="bg-brand-50/50 p-6 rounded-2xl flex flex-wrap items-center gap-4">
                ...
                <span className="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded ml-auto uppercase">Voucher Sẵn Có</span>
              </div>

              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  <span className="text-sm font-medium text-gray-500 w-20">Mã giảm giá:</span>
                  <div className="flex gap-2">
                    <span className="px-3 py-1 border border-dashed border-brand-400 text-brand-600 text-xs rounded bg-brand-50">GIẢM 10%</span>
                    <span className="px-3 py-1 border border-dashed border-brand-400 text-brand-600 text-xs rounded bg-brand-50">GIẢM 12%</span>
                  </div>
                </div>
              ...
              <div className="flex gap-3 pt-4">
                <button 
                  ...
                  className="flex-grow bg-brand-400 text-white py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-brand-500 transition-all shadow-lg shadow-brand-100 active:scale-95"
                >
                  Mua Online
                </button>
                <button 
                  onClick={handleAddToCart}
                  className="flex-grow border-2 border-brand-300 text-brand-500 py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-brand-50 transition-all active:scale-95"
                >
                  Thêm vào giỏ hàng
                </button>
                <button 
                    ...
                    className={cn(
                        "p-4 border border-gray-200 rounded-xl transition-all",
