...
import { Package, User as UserIcon, Calendar, MapPin, Phone, Mail, ChevronRight, ShoppingBag, Edit2, Save, X, Star } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-6 py-24 min-h-screen">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
        ...
        >
          ...
          <div className="p-8 rounded-[3rem] bg-brand-500 text-white overflow-hidden relative group">
            ...
            <h3 className="text-lg font-serif mb-2">Ưu đãi của bạn</h3>
            <p className="text-xs text-white/80 leading-relaxed mb-6">Bạn đang có 0 xu Q&H LUMINA. Mua sắm thêm để nhận nhiều ưu đãi hơn nhé!</p>
            <Link to="/" className="inline-flex items-center space-x-2 text-[10px] font-bold uppercase tracking-widest bg-white text-brand-500 px-6 py-3 rounded-full hover:bg-brand-50 transition-colors">
